...
public class XMPPError extends AbstractError {
    ...
    public XMPPError(Condition condition) {
        this(condition, null, null, null, null, null, null, null);
    }
    ...
    public XMPPError(Condition condition, ExtensionElement applicationSpecificCondition) {
        this(condition, null, null, null, null, Arrays.asList(applicationSpecificCondition), null, null);
    }
    ...
    public XMPPError(Condition condition, String conditionText, String errorGenerator, Type type, Map<String, String> descriptiveTexts,
        ...
        this(condition, conditionText, errorGenerator, type, descriptiveTexts, extensions, null, null);
    }
     ...
     */
    public XMPPError(Condition condition, String conditionText, String errorGenerator, Type type, Map<String, String> descriptiveTexts,
            List<ExtensionElement> extensions, Stanza stanza, String code) {
    ...
    public String toString() {
        ...
        sb.append(condition.toString()).append(" - ").append(type.toString()).append(" - ").append(code);
